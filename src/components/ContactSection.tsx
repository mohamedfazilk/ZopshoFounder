      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center space-y-8">
            <div>
              <h3 className="text-2xl font-semibold text-gray-900 mb-6">Follow My Journey</h3>
              <div className="flex justify-center space-x-8">
                ...
                >
                  <div className="p-2 bg-gray-100 rounded-lg group-hover:bg-gray-200 transition-colors duration-300">
                    <Github size={24} className="text-gray-700 group-hover:text-gray-900 transition-colors duration-300" />
                  </div>
            ...
            {/* <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Ready to Make an Impact Together?</h3>
              <p className="text-lg mb-6 opacity-90">
                Whether you're looking to revolutionize logistics, build communities, or create positive social change, I'd love to hear from you.
              </p>
              <Button variant="secondary" className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-3 rounded-full font-semibold transition-all duration-300 transform hover:scale-105">
